...
var colors = [[0, 0, 0], [29, 43, 83], [126, 37, 83], [0, 135, 81], [171, 82, 54], [95, 87, 79], [194, 195, 199], [255, 241, 232], [255, 0, 77], [255, 163, 0], [255, 236, 39], [0, 228, 54], [41, 173, 255], [131, 118, 156], [255, 119, 168], [255, 204, 170]]; // const palette = new JitterMatrix(4, 'char', 256, 1)
...
function pset(x, y, c) {
  ...
  screen.setcell2d.apply(screen, [x, y].concat(_toConsumableArray(colors[_c])));
}
...
function rectfill(rect_obj, c) {
  ...
  rect_obj = rect_swap(rect_obj); // coord_cam_offset(this, &x0, &y0);
  ...
  for (var i_1 = y0; i_1 <= y1; ++i_1) {// memset(screen.begin + i * screen_width + x0, c, size_t(x1 - x0 + 1))
  }
...
function line(x0, y0, x1, y1, c) {
  ...
  if (y0 == y1) {// return rectfill(x0, y0, x1, y1, c)
  }
